...
class TestBigQueryClient:
    ...
    def test_init_with_credentials(self):
        ...
        with patch('google.cloud.bigquery.Client.from_service_account_info') as mock_from_service_account:
            mock_client = MagicMock()
    ...
    def test_create_table_from_yaml_new_table(self, bigquery_client, mock_bigquery_client, sample_schema):
        ...
        schema_path = os.path.normpath(os.path.join(test_dir, "../test_data/test_config_schema.yaml"))
        
        with patch('forklift.bigquery.utils.load_schema_from_yaml', return_value=schema_info):
        ...
        assert "deleteIntermediateOutputFiles" in result["field_attributes"]["terra_method_config"]["properties"]
    
    def test_create_table_from_yaml_existing_table(self, bigquery_client, mock_bigquery_client, sample_schema):
    ...
    def test_create_table_from_yaml_existing_table_error(self, bigquery_client, mock_bigquery_client, sample_schema):
    ...
    def test_insert_rows_success(self, bigquery_client, mock_bigquery_client):
        ...
        sample_rows = [
            {"id": "3f0900b6-8b0b-48ca-948e-fdaccefb5220", "name": "VRDL", "created_at": "2025-02-24T00:00:00"},
            {"id": "3f0900b6-8b0b-48ca-948e-fdaccefb5221", "name": "VRDL", "created_at": "2025-02-24T00:00:00"}
        ]
        ...
        job_config = mock_bigquery_client.load_table_from_file.call_args[1]["job_config"]
