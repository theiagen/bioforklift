...
county_config_table_exists = bq.table_exists("andrew_configs")
...
samples_table_exists = bq.table_exists("andrew_samples")
if not samples_table_exists:
    samples_table_create_res = bq.create_table(
        table_name="andrew_samples", schema_yaml="andrew_samples_schema.yaml"
    )
