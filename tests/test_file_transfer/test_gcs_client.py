...
class TestGCSTransferClient:
    ...
    def mock_storage_client(self):
        ...
        with patch(
            "bioforklift.file_transfers.gcs_transfer.storage.Client",
    ...
    def test_transfer_file(self, mock_storage_client):
        ...
        result = client._transfer_file(
            "gs://source-bucket/file.txt", "gs://dest-bucket/file.txt"
        )
    ...
    def test_transfer_sequence_files(self, mock_storage_client, test_dataframe):
        ...
        client = GCSTransferClient("dest-bucket")
        client._execute_transfers = MagicMock(
            return_value=[
                {"success": True, "source": src, "destination": dst}
                for src, dst in [
                    (
                        "gs://source-bucket/path/to/file1.fastq.gz",
                        "gs://dest-bucket/path/to/file1.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file2.fastq.gz",
                        "gs://dest-bucket/path/to/file2.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file3.fastq.gz",
                        "gs://dest-bucket/path/to/file3.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file1_r2.fastq.gz",
                        "gs://dest-bucket/path/to/file1_r2.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file2_r2.fastq.gz",
                        "gs://dest-bucket/path/to/file2_r2.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file3_r2.fastq.gz",
                        "gs://dest-bucket/path/to/file3_r2.fastq.gz",
                    ),
                ]
            ]
        )
        ...
        result_df = client.transfer_sequence_files(
            test_dataframe, ["read1", "read2"], preserve_path_structure=True
        )
    ...
    def test_transfer_sequence_files_with_empty_columns(
        self, mock_storage_client, test_dataframe
    ):
        ...
        result_df = client.transfer_sequence_files(
            test_dataframe, ["non_existent_column"]
        )
        assert result_df.equals(test_dataframe)

    def test_transfer_sequence_files_without_path_structure(
        self, mock_storage_client, test_dataframe
    ):
        ...
        client._execute_transfers = MagicMock(
            return_value=[
                ...
                for src, dst in [
                    (
                        "gs://source-bucket/path/to/file1.fastq.gz",
                        "gs://dest-bucket/file1.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file2.fastq.gz",
                        "gs://dest-bucket/file2.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file3.fastq.gz",
                        "gs://dest-bucket/file3.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file1_r2.fastq.gz",
                        "gs://dest-bucket/file1_r2.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file2_r2.fastq.gz",
                        "gs://dest-bucket/file2_r2.fastq.gz",
                    ),
                    (
                        "gs://source-bucket/path/to/file3_r2.fastq.gz",
                        "gs://dest-bucket/file3_r2.fastq.gz",
                    ),
                ]
            ]
        )
        ...
        result_df = client.transfer_sequence_files(
            test_dataframe, ["read1", "read2"], preserve_path_structure=False
        )
